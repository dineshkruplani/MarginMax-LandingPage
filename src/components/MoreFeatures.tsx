    ...
    <section className="py-20 px-6 bg-black">
      <div className="container mx-auto">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-lg md:text-xl lg:text-2xl font-medium text-white mb-6">
            and there's more...
          </h2>
        </motion.div>

        {/* Feature Buttons Grid - 2+3 Layout */}
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            {features.slice(0, 2).map((feature, index) => (
              <motion.div
                key={index}
                className={`${feature.bgColor} rounded-2xl p-6 cursor-pointer transition-all duration-300`}
